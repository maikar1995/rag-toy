...
from ...rag.models import Citation, AnswerResponse
import logging

logger = logging.getLogger(__name__)

def validate_citations_hard_fail(answer: AnswerResponse, used_citations: List[Citation], retry_fn=None) -> AnswerResponse:
    """
